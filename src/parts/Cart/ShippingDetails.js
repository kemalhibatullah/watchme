                ...
                <form action="success.html">
                        ...
                        <div className="flex -mx-2 flex-wrap">
                            <div className="px-2 w-6/12 h-24 mb-4">
                                <button
                                    ...
                                    data-value="fedex"
                                    data-name="courier"
                                    className="border border-gray-200 focus:border-blue-700 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                                >
                                    <img
                    ...
                    <div className="text-center">
                        <button
                            type="submit"
                            // disabled
                            className="bg-blue-700 text-white hover:bg-blue-500 hover:text-white focus:outline-none w-full py-3 rounded-full text-lg focus:text-black transition-all duration-200 px-6"
                        >
                            Checkout Now
                        </button>
                    </div>
