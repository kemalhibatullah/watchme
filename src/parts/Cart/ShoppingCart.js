        ...
        <div className="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
            ...
            >
                ...
                <div className="px-4 w-auto flex-1 md:w-5/12">
                    <div className="">
                        <h6 className="font-semibold text-base md:text-base leading-8">
                            CLASSIC DURHAM
                        </h6>
                        <span className="text-sm md:text-sm">Daniel Wellington</span>
                        <h6
                ...
                >
                    <div className="">
                        <h6 className="font-semibold text-md">Rp 1.999.000</h6>
                    </div>
                </div>
                <div className="px-4 w-2/12">
                    <div className="text-center">
            ...
            >
                ...
                <div className="px-4 w-auto flex-1 md:w-5/12">
                    <div className="">
                        ...
                        <span className="text-sm md:text-sm">Rolex, Explorer</span>
                        <h6
                            className="font-semibold text-base md:text-lg block md:hidden"
                        >
                            Rp 200.999.000
                ...
                >
                    <div className="">
                        <h6 className="font-semibold text-md">Rp 200.999.000</h6>
                    </div>
                </div>
                <div className="px-4 w-2/12">
                    <div className="text-center">
            ...
            >
                ...
                <div className="px-4 w-auto flex-1 md:w-5/12">
                    <div className="">
                        ...
                        <span className="text-sm md:text-sm">Apple</span>
                        <h6
                            className="font-semibold text-base md:text-lg block md:hidden"
                        >
                            Rp 6.999.000
                ...
                >
                    <div className="">
                        <h6 className="font-semibold text-md">Rp 6.999.000</h6>
                    </div>
                </div>
                <div className="px-4 w-2/12">
                    <div className="text-center">
